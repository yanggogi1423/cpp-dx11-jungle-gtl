...
IF(${NV_CLOTH_ENABLE_CUDA})
LIST(APPEND NVCLOTH_PLATFORM_INCLUDES PRIVATE ${CUDA_INCLUDE_DIRS})
ENDIF()
...
IF(CUDA_VERSION VERSION_LESS "11.0")
	SET(NVCLOTH_CUDA_GENCODE
		-gencode arch=compute_30,code=sm_30
		-gencode arch=compute_35,code=sm_35
		-gencode arch=compute_50,code=sm_50
		-gencode arch=compute_60,code=sm_60
	)
ELSEIF(CUDA_VERSION VERSION_LESS "13.0")
	SET(NVCLOTH_CUDA_GENCODE
...
set(
	...
	-Xcompiler=/wd4819 -use_fast_math -ftz=true -prec-div=false -prec-sqrt=false -lineinfo ${NVCLOTH_CUDA_GENCODE} -D_USE_MATH_DEFINES -DNDEBUG -DPX_PROFILE=1
)
