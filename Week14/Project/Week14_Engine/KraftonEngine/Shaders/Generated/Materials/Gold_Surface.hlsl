...
{
    float3 n_1 = float3(0.598000f, 0.337000f, 0.000000f);
    float4 n_26 = Tex_Diffuse.Sample(LinearWrapSampler, Input.UV0);
    float n_45 = 0.070000f;
    float n_40 = ((n_26).g * n_45);
    float n_3 = 1.000000f;
    FMaterialResult Result;
    Result.BaseColor = n_1;
    Result.Normal = float3(0, 0, 1);
    Result.Roughness = n_40;
    Result.Metallic = (n_26).b;
