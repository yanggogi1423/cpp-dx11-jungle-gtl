...
namespace EditorViewportInputMapping
{
    ...
    inline const TArray<FInputBinding>& GetBindings()
    {
        static const TArray<FInputBinding> Bindings =
        {
            ...
            { static_cast<int32>(EEditorViewportAction::SaveSceneAs), EInputBindingTrigger::Pressed, { 'S', true, false, true }, EInputEventType::KeyPressed, 106 },
            { static_cast<int32>(EEditorViewportAction::Undo), EInputBindingTrigger::Pressed, { 'Z', true, false, false }, EInputEventType::KeyPressed, 107 },
            { static_cast<int32>(EEditorViewportAction::Redo), EInputBindingTrigger::Pressed, { 'Z', true, false, true }, EInputEventType::KeyPressed, 108 },
            ...
            { static_cast<int32>(EEditorViewportAction::ReleasePIEMouseFocus), EInputBindingTrigger::Pressed, { VK_F1, false, false, true }, EInputEventType::KeyPressed, 191 },
