...
public:
	...
	using FShortcutHandler = std::function<bool(const FViewportInputContext& Context)>;
	...
	void SetShortcutHandler(FShortcutHandler InHandler);
...
private:
	...
	FShortcutHandler ShortcutHandler;
};
