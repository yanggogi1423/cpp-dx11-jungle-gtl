...
private:
	...
	void RenderReflectedProperties(UObject* Object);
	void RenderReflectedFunctions(UObject* Object);
	void RenderReflectedPropertyWidget(UObject* Object, FProperty* Property);
	void RenderPropertyValue(UObject* OwnerObject, FProperty* Property, void* ValueAddress, const char* Label, FProperty* NotifyProperty);
	void RenderObjectPropertyValue(UObject* OwnerObject, FObjectProperty* Property, void* ValueAddress, const char* Label, FProperty* NotifyProperty);
	void RenderStructPropertyValue(UObject* OwnerObject, FStructProperty* Property, void* ValueAddress, const char* Label, FProperty* NotifyProperty);
	void PostEditReflectedProperty(UObject* Object, FProperty* Property);
	void BeginPropertyEditState(UObject* Object, const FString& Label);
	void CommitPropertyEditState(UObject* Object, const FString& Label);
	void RecordImmediateObjectStateEdit(
		UObject* Object,
		const FEditorObjectState& BeforeState,
		const FString& Label);

	void RenderArrayProperty(UObject* Object, FArrayProperty* ArrayProp);
	void RenderStaticMeshAssetProperty(UObject* Object, FObjectProperty* Property);
	void RenderSkeletalMeshAssetProperty(UObject* Object, FObjectProperty* Property);
	void RenderAnimationAssetProperty(UObject* Object, FObjectProperty* Property);
	void RenderAnimLuaProgramAssetProperty(UObject* Object, FObjectProperty* Property);
	void RenderSkeletalAnimationStateMachineProperty(class USkeletalMeshComponent* SkeletalComp);
	void RenderMaterialAssetProperty(UObject* OwnerObject, FObjectProperty* Property, void* ValueAddress, const char* Label, FProperty* NotifyProperty);
	...
	bool bPropertyEditStateCaptured = false;
	...
	UObject* PendingPropertyEditObject = nullptr;
	FString PendingPropertyEditLabel;
	FEditorObjectState PendingPropertyEditBeforeState;
