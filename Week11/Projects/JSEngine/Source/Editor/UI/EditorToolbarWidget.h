...
public:
	...
	void SetAnimationSequenceViewerOpenCallback(
...
private:
	...
	std::function<void()> AnimationSequenceViewerOpenCallback;
	std::function<bool()> AnimationSequenceViewerCanOpenCallback;
