...
private:
	...
	FMapProperty* FindMaterialParamMapProperty(UMaterialInterface* Material) const;
	void CollectMaterialParamsFromProperty(UMaterialInterface* Material, TMap<FString, FMaterialParamValue>& OutParams);
