...
public:
	...
	const TArray<FString>& GetAnimLuaProgramAssetPaths() const { return AnimLuaProgramPaths; }
	...
	UAnimSequence* LoadAnimSequence(const FString& Path, const USkeletalMesh* TargetMesh, int32 AnimStackIndex = 0) const;
	UAnimLuaProgramAsset* LoadAnimLuaProgramAsset(const FString& Path) const;
...
private:
	...
	TArray<FString> AnimLuaProgramPaths;
