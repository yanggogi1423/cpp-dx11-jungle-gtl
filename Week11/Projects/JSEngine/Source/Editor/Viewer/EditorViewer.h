...
public:
	...
	void ChangeTarget(const FString& InMeshFileName, const FString& InDocumentFileName);

    const FString& GetFileName() const { return FileName; }
    void SetRenderWithoutEditorTab(bool bInRenderWithoutEditorTab)
    {
        bRenderWithoutEditorTab = bInRenderWithoutEditorTab;
    }
    bool ShouldRenderWithoutEditorTab() const { return bRenderWithoutEditorTab; }
...
private:
    ...
    FString FileName;
    bool bRenderWithoutEditorTab = false;
