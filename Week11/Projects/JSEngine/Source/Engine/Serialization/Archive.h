...
struct FArchive
{
	...
	virtual EArchiveFormat GetFormat() const = 0;

	bool IsJson() const { return GetFormat() == EArchiveFormat::Json; }
	bool IsBinary() const { return GetFormat() == EArchiveFormat::Binary; }
	...
	virtual FArchive& operator<<(FQuat& Value) = 0;
