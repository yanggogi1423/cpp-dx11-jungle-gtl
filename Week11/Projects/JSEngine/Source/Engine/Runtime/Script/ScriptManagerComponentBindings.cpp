...
void FScriptManager::BindComponentTypes()
{
    ...
    LUA_PROPERTY(TypeName, [](UActorComponent& Component) -> FString
                 { return Component.GetClass() && !Component.GetClass()->ClassName.empty() ? Component.GetClass()->ClassName : ""; });
    ...
    LUA_METHOD(SetWorldRotation, SetWorldRotation);
    LUA_METHOD(AddRelativeRotation, AddRelativeRotation);
    LUA_METHOD(AddLocalRotation, AddLocalRotation);
    LUA_METHOD(AddWorldRotation, AddWorldRotation);
    ...
    LUA_RO_PROPERTY(WorldRotation, GetWorldRotation);
...
void FScriptManager::BindCameraTypes()
{
    ...
    LUA_METHOD(set_view_world_rotation_degrees, SetViewWorldRotationDegrees);
    LUA_METHOD(set_view_local_rotation_degrees, SetViewLocalRotationDegrees);
...
void FScriptManager::BindSkeletalMeshTypes()
{
    ...
    LUA_SET(GetLuaAnimInstance, [](USkeletalMeshComponent& Self) -> ULuaAnimInstance*
            { return Cast<ULuaAnimInstance>(Self.GetAnimInstance()); });
    LUA_SET(GetAnimStateMachineInstance, [](USkeletalMeshComponent& Self) -> UAnimStateMachineInstance*
            { return Cast<UAnimStateMachineInstance>(Self.GetAnimInstance()); });
    LUA_END_TYPE();
}
