...
void FRenderer::CreateResources()
{
	...
	Resources.SkinningConstantBuffer.Create(Device.GetDevice(), sizeof(FSkeletalSkinningConstants));
	Resources.SkinningMatrixBuffer.Create(Device.GetDevice(), sizeof(FMatrix), 4096);
...
void FRenderer::Release()
{
	...
	Resources.SkinningConstantBuffer.Release();
	Resources.SkinningMatrixBuffer.Release();
...
void FRenderer::UpdateFrameBuffer(ID3D11DeviceContext* Context, const FRenderBus& InRenderBus)
{
    ...
    const FShowFlags ShowFlags = InRenderBus.GetShowFlags();
    frameConstantData.bBoneWeightHeatmap = ShowFlags.bBoneWeightHeatmap ? 1.0f : 0.0f;
    frameConstantData.BoneWeightHeatmapBoneIndex = static_cast<float>(ShowFlags.BoneWeightHeatmapBoneIndex);
