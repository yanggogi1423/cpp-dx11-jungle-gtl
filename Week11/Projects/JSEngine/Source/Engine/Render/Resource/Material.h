...
{
	GENERATED_STRUCT_BODY(FMaterialParamValue)
...
public:
	UPROPERTY(VisibleAnywhere, DisplayName = "Name", Category = "Material")
	FString Name;
	
	UPROPERTY(VisibleAnywhere, DisplayName = "File Path", Category = "Material")
	FString FilePath;

	UPROPERTY(VisibleAnywhere, DisplayName = "Imported Name", Category = "Material")
	...
	UPROPERTY(EditAnywhere, DisplayName = "Material Parameters")
...
public:
	UPROPERTY(VisibleAnywhere, DisplayName = "Name", Category = "Material Instance")
	FString Name;

	UPROPERTY(VisibleAnywhere, DisplayName = "File Path", Category = "Material Instance")
	FString FilePath;

	UPROPERTY(VisibleAnywhere, DisplayName = "Parent Material", Category = "Material Instance")
