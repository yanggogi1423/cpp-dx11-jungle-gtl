...
struct FFrameConstants
{
    ...
    float bBoneWeightHeatmap = 0.0f;
    float BoneWeightHeatmapBoneIndex = -1.0f;
    FVector2 BoneWeightHeatmapPadding;
};
...
struct FSkeletalSkinningConstants
{
	uint32 BoneCount = 0;
	uint32 bUseGPUSkinning = 0;
