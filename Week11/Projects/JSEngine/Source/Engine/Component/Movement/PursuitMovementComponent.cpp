...
void UPursuitMovementComponent::Serialize(FArchive& Ar)
{
    ...
    Ar << "Pursuit Interval" << UpdateLerpInterval;
    Ar << "Detection Radius" << DetectionRadius;
    Ar << "Pursuit Speed" << PursuitSpeed;
    Ar << "Orient To Target" << bFaceTargetDir;
    Ar << "Auto Target Perspective Camera" << bAutoTargetPerspCamera;
}
