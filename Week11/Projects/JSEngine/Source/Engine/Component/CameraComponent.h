...
struct FCameraState
{
	GENERATED_STRUCT_BODY(FCameraState)

	UPROPERTY(EditAnywhere, Category = "Camera", DisplayName = "Field of View")
	float FOV = 3.14159265358979f / 3.0f;

	float AspectRatio = 16.0f / 9.0f;

	UPROPERTY(EditAnywhere, Category = "Camera", DisplayName = "Near Plane")
	float NearZ = 0.1f;
	UPROPERTY(EditAnywhere, Category = "Camera", DisplayName = "Far Plane")
	float FarZ = 1000.0f;

	UPROPERTY(EditAnywhere, Category = "Camera", DisplayName = "Orthographic Width")
	float OrthoWidth = 10.0f;

	UPROPERTY(EditAnywhere, Category = "Camera", DisplayName = "Orthographic Projection")
...
public:
	...
	void SetViewWorldRotationDegrees(float PitchDegrees, float YawDegrees);
	void SetViewLocalRotationDegrees(float PitchDegrees, float YawDegrees);
