...
private:
	...
	UPROPERTY(EditAnywhere, Category = "Text", DisplayName = "Color")
	FVector4 Color = FVector4(1.0f, 1.0f, 1.0f, 1.0f);
	UPROPERTY(EditAnywhere, Category = "Text", DisplayName = "Font Size")
	float FontSize = 1.0f;
	UPROPERTY(EditAnywhere, Category = "Text", DisplayName = "Character Spacing")
	float Spacing = 0.1f;
	UPROPERTY(EditAnywhere, Category = "Text", DisplayName = "Character Width")
	float CharWidth = 0.5f;
	UPROPERTY(EditAnywhere, Category = "Text", DisplayName = "Character Height")
	float CharHeight = 0.5f;

	UPROPERTY(EditAnywhere, Category = "Text", DisplayName = "Render Space")
	ETextRenderSpace RenderSpace = ETextRenderSpace::World;
	UPROPERTY(EditAnywhere, Category = "Text", DisplayName = "Horizontal Alignment")
	ETextHAlign HAlign = ETextHAlign::Center;
	UPROPERTY(EditAnywhere, Category = "Text", DisplayName = "Vertical Alignment")
