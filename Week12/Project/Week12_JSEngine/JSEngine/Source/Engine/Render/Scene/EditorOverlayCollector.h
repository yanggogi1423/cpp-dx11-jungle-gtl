...
public:
    ...
    void CollectCollisionShape(UPrimitiveComponent* PrimitiveComponent, const FShowFlags& ShowFlags, FRenderBus& RenderBus) const;
...
private:
    ...
    void CollectSphereCommand(const FVector& Center, float Radius, const FColor& Color, FRenderBus& RenderBus) const;
    void CollectCapsuleCommand(const FVector& Start, const FVector& End, float Radius, const FColor& Color, FRenderBus& RenderBus) const;
