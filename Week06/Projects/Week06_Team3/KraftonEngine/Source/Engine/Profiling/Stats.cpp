...
uint32 FDecalStats::ProjectionDecalActorCount = 0;
uint32 FDecalStats::RenderedDecalCount = 0;
uint32 FDecalStats::RenderedProjectionDecalCount = 0;
uint32 FDecalStats::AffectedObjectCountSum = 0;
uint32 FDecalStats::AffectedObjectCountMax = 0;
uint32 FDecalStats::ProjectionDecalVertexCount = 0;
uint32 FDecalStats::ProjectionDecalTriangleCount = 0;
uint32 FDecalStats::ProjectionDecalSectionCount = 0;
