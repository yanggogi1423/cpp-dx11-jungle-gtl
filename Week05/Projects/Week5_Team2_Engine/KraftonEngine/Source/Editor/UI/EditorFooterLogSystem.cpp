...
void FEditorFooterLogSystem::Tick(float DeltaTime)
{
...
void FEditorFooterLogSystem::Push(const FString& InMessage, float InLifetimeSeconds)
{
...
TArray<FString> FEditorFooterLogSystem::GetActiveMessages() const
{
